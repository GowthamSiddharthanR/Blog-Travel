  ...
  return (
    <>
      <div className="container mx-auto px-5 mb-10">
        <div className="grid grid-cols-1 gap-16 md:gap-40 md:grid-cols-2 md:my-16 my-8 lg:gap-40 lg:grid-cols-2">
          <div className="">
            <Link href="/post_1">
              <div className="grid grid-cols-12 gap-4  ">
                <div className="col-start-1 col-span-12 ">
                  ...
                  <figure className="relative max-w-sm transition-all duration-300 cursor-pointer filter grayscale hover:grayscale-0">
                    <span  >
                      <img className=" rounded-lg  xl:max-w-xl  lg:max-w-lg md:max-w-sm" style={{ height: "325px" }} src="https://www.tripplannersindia.com/assets/images/postimages/Aagaya_Gangai_Waterfalls.webp" alt="" />
                    </span>
                  </figure>
                </div>
            ...
            <div className="grid grid-cols-1 gap-3  md:col-span-2 mt-4 ">
              <h2 className="font-sans font-semibold tracking-tighter text-primary text-2xl md:text-2xl lg:text-3xl">
                <Link href="/post_1">
              ...
              <div className="grid grid-cols-12 gap-4  ">
                <div className="col-start-1 col-span-12">
                  <figure className="relative max-w-lg transition-all duration-300 cursor-pointer filter grayscale hover:grayscale-0">
                    <span  >
                      <img className="rounded-lg xl:max-w-xl lg:max-w-lg md:max-w-sm" style={{ height: "325px" }} src="https://content.r9cdn.net/rimg/dimg/26/2e/ad960cee-city-60709-168cd171c21.jpg?width=1366&height=768&xhint=1370&yhint=964&crop=true&watermarkposition=lowerright" alt="" />
                    </span>
                  </figure>
                </div>
              </div></Link>
              ...
              <div className="grid grid-cols-12 gap-4  ">
                <div className="col-start-1 col-span-12">
                  ...
                  <figure className=" max-w-sm transition-all duration-300 cursor-pointer filter grayscale hover:grayscale-0">
                    <span  >
                      <img className="rounded-lg xl:max-w-xl lg:max-w-lg md:max-w-sm" style={{ height: "325px" }} data-nimg="fill" src="https://www.indiautentica.com/wp-content/uploads/2022/10/29ezcwtmtnm.jpg" alt="" />
                    </span>
                  </figure>
                </div>
              </div>
            ...
            <Link href="/post_4">
              <div className="grid grid-cols-12 gap-4  ">
                <div className="col-start-1 col-span-12">
                  ...
                  <figure className="relative max-w-sm transition-all duration-300 cursor-pointer filter grayscale hover:grayscale-0">
                    <span  >
                      <img className="rounded-lg xl:max-w-xl lg:max-w-lg md:max-w-sm" style={{ height: "325px" }} src="https://himalayanrider.wordpress.com/wp-content/uploads/2018/03/img_20170609_185809_hdr.jpg?w=672&h=372&crop=1" alt="" />
                    </span>
                  </figure>
                </div>
              </div></Link>
            ...
            <Link href="/post_5">
              <div className="grid grid-cols-12 gap-4  ">
                <div className="col-start-1 col-span-12">
                  ...
                  <figure className="relative max-w-sm transition-all duration-300 cursor-pointer filter grayscale hover:grayscale-0">
                    <span  >
                      <img className="rounded-lg xl:max-w-xl lg:max-w-lg md:max-w-sm" style={{ height: "325px" }} src="https://www.shutterstock.com/image-photo/arial-view-auroville-experimental-township-600nw-1967101996.jpg" alt="" />
                    </span>
                  </figure>
                </div>
              </div></Link>
            ...
            <Link href="/post_6">
              <div className="grid grid-cols-12 gap-4  ">
                <div className="col-start-1 col-span-12">
                  ...
                  <figure className="relative max-w-sm transition-all duration-300 cursor-pointer filter grayscale hover:grayscale-0">
                    <span  >
                      <img className="rounded-lg xl:max-w-xl lg:max-w-lg md:max-w-sm" style={{ height: "325px" }} src="https://www.cholaimpressions.com/Blog%20Images/Culture%20And%20Tourism/4193143492_ca23db0df4_o.jpg" alt="" />
                    </span>
                  </figure>
                </div>
              </div></Link>
